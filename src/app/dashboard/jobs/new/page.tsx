                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select className="w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-primary-500" value={form.employment_type} onChange={e => setForm({ ...form, employment_type: e.target.value })}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" placeholder="$60k - $80k DOE" className="w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-primary-500" value={form.salary_range} onChange={e => setForm({ ...form, salary_range: e.target.value })} />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold mb-1">Application Link (URL)</label>
                            <input type="url" placeholder="https://..." className="w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-primary-500" value={form.application_url} onChange={e => setForm({ ...form, application_url: e.target.value })} />
                        </div>
                    </div>

                    <div>
                        <label className="block text-sm font-semibold mb-1">Job Description *</label>
                        <textarea required rows={6} className="w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-primary-500" value={form.description} onChange={e => setForm({ ...form, description: e.target.value })} />
                    </div>
