    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm shadow-blue-500/5">
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm shadow-blue-500/5 relative overflow-hidden">
                    <h3 className="text-gray-500 text-sm font-medium mb-2">Premium MRR</h3>
                    <p className="text-3xl font-bold text-emerald-600">${mrr.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                    <ArrowUpRight size={64} className="absolute right-[-10px] bottom-[-10px] text-emerald-500/10" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link href="/dashboard/listings/new" className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md transition group">
                    <h3 className="text-lg font-bold group-hover:text-blue-600 mb-1">Create New Listing &rarr;</h3>
                ...
                <Link href="/dashboard/listings" className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md transition group">
                    <h3 className="text-lg font-bold group-hover:text-blue-600 mb-1">Manage Listings &rarr;</h3>
